...
module "vpc" {
  ...
  owner       =  "Jane Doe"
  vpc_cidr    =  "172.62.0.0/16"
  public_subnet_1 = "172.62.0.0/18"
  public_subnet_2 = "172.62.64.0/18"
  private_subnet_1 = "172.62.128.0/18"
  private_subnet_2 = "172.62.192.0/18"
}
